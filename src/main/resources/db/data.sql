...
insert into `review` (content, created_at, updated_at, rating, classification, member_id, duty_id) values
	...
	("처음 방문한 병원이었는데, 대기 시간이 길지 않았고, 직원들이 친절하게 응대해주셔서 기분 좋게 진료를 받을 수 있었습니다 😊. 의사 선생님은 매우 친절하고 증상에 대해 꼼꼼하게 설명해주셨고, 필요한 치료를 신속하게 진행해주셔서 매우 만족스러웠습니다 💉. 병원 내부는 현대적이고 깔끔하여 치료 환경이 매우 쾌적했습니다 🏥. 진료 후에도 필요한 처방이 빠르게 이루어져 좋았습니다 💊.", "2024-09-07 00:00:00", 3, '병원', 'jackfruit123', 'A1107084'),
	...
	("약국 직원들이 진짜 친절하고, 필요한 약도 정확하게 준비해줘서 너무 좋았어. 💊😊", "2024-09-07 00:00:00", 3, '약국', 'jackfruit123', 'C1110242'),
